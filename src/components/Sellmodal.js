    ...
    if(props.show){
        return (
          <div className='modal-main'>
              ...
              <button className='btn btn-success' onClick={()=>{props.event(false);document.body.style.overflow='visible';document.getElementById('neighbourhoodid').style.filter='none'}}>Submit</button>
              </div>
          </div>
        )}
}
